...
export default {
    ...
    var data = {
      ...
      options: {
        ...
        customBackend: {
          ...
          "l0tus0.vercel.app": "https://l0tus0.vercel.app/sub?",
        ...
        backendOptions: [
          ...
          { value: "https://l0tus0.vercel.app/sub?" },
          ...
          },
          {
            ...
            options: [
              ...
              },
              {
                label: "全分组 多模式 🔞🔬🛑 (for🖥@🎓️)",
                value:
                  "https://raw.githubusercontent.com/L0tus0/l0tus0-web/master/rule%26config/config/Full_Multi_NoAd_Scholar_AAD.ini"
              },
              {
                label: "全分组 多模式 🔞 (for🌐@🏠)",
                value:
              ...
              },
              {
                label: "全分组 多模式 🔞🔬🆎 (for🖥@🎓️)",
                value:
                  "https://raw.githubusercontent.com/L0tus0/l0tus0-web/master/rule%26config/config/Full_Multi_NoAd_Scholar_ABP.ini"
              },
            ]
          },
          {
  ...
  mounted() {
    ...
    this.form.remoteConfig = "https://raw.githubusercontent.com/L0tus0/l0tus0-web/master/rule%26config/config/Full_NoAd_Scholar_AAD.ini";
